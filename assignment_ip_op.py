...
"""
# 2) program.
print(input("enter message1: "),input("enter message2: "))
"""
...
"""
# 3) program.
print("this is ",input("enter name: "),", my age is",input("enter age: "),", my favorite color is ",input("enter favorite color: "))
